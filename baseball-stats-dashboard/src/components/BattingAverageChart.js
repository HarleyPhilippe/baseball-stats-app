...
const BattingAverageChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://baseball-stats-api.onrender.com/stats/all_players/games");
        ...
        if (response.data && response.data.length > 0) {
          ...
          const datasets = players.map((player, index) => ({
            ...
            data: response.data
              ...
              .map(game => parseFloat(game.batting_average)),
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: "center" }}>Batting Average Trends</h2>
        ...
        <Line
          ...
          options={{
              ...
              tooltip: {
                ...
                callbacks: {
                  label: function (tooltipItem) {
                    return `Batting Avg: ${tooltipItem.raw.toFixed(3)}`;
                  }
                }
              }
            },
            scales: {
              ...
              y: { title: { display: true, text: "Batting Average" } }
            }
          }}
        />
      </div>
...
export default BattingAverageChart;
