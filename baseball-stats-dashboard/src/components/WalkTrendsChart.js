...
const WalkTrendsChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://baseball-stats-api.onrender.com/stats/all_players/walks");
        ...
        if (response.data && response.data.length > 0) {
          ...
          const datasets = players.map((player, index) => ({
            ...
            data: response.data
              ...
              .map(game => parseInt(game.total_walks, 10)),
  ...
  return (
    <div style={{
      ...
      <h2 style={{ textAlign: "center" }}>Walk Trends</h2>
        ...
        <Line
          ...
          options={{
            ...
            scales: {
              ...
              y: { title: { display: true, text: "Walks" } }
            }
          }}
        />
      </div>
...
export default WalkTrendsChart;
