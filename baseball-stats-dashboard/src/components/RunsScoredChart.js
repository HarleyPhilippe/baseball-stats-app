...
const RunsScoredChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://baseball-stats-api.onrender.com/stats/all_players/runs");
        ...
        if (response.data && response.data.length > 0) {
          ...
          const datasets = players.map((player, index) => ({
            ...
            data: response.data
              ...
              .map(game => parseInt(game.total_runs)), // Ensure it's an integer
  ...
  return (
    <div style={{
      ...
      <h2 style={{ textAlign: "center" }}>Runs Scored Trends</h2>
        ...
        <Line
          ...
          options={{
            ...
            scales: {
              ...
              y: { title: { display: true, text: "Runs Scored" } }
            }
          }}
        />
      </div>
...
export default RunsScoredChart;
