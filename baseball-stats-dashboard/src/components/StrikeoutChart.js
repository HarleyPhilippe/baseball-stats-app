...
const StrikeoutChart = () => {
        ...
        if (response.data && response.data.length > 0) {
          ...
          const datasets = players.map((player, index) => ({
            ...
            data: response.data
              ...
              .map(game => parseFloat(game.total_strikeouts)),
  ...
  return (
    <div style={{
      ...
      <h2 style={{ textAlign: "center" }}>Strikeout Trends</h2>
        ...
        <Line
          ...
          options={{
              ...
              tooltip: {
                ...
                callbacks: {
                  label: function (tooltipItem) {
                    return `Strikeouts: ${tooltipItem.raw}`;
                  }
                }
              }
            },
            scales: {
              ...
              y: { title: { display: true, text: "Total Strikeouts" } }
            }
          }}
        />
      </div>
