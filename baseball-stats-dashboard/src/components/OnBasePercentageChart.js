...
const OnBasePercentageChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://baseball-stats-api.onrender.com/stats/all_players/obp");
        ...
        if (response.data && response.data.length > 0) {
          ...
          const datasets = players.map((player, index) => ({
            ...
            data: response.data
              ...
              .map(game => parseFloat(game.on_base_percentage)),
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: "center" }}>On-Base Percentage Trends</h2>
        ...
        <Line
          ...
          options={{
              ...
              tooltip: {
                ...
                callbacks: {
                  label: function (tooltipItem) {
                    return `OBP: ${tooltipItem.raw.toFixed(3)}`;
                  }
                }
              }
            },
            scales: {
              ...
              y: { title: { display: true, text: "On-Base Percentage" } }
            }
          }}
        />
      </div>
...
export default OnBasePercentageChart;
