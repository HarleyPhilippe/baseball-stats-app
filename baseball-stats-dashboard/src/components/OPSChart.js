...
const OPSChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://baseball-stats-api.onrender.com/stats/all_players/ops");
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: "center" }}>OPS (On-Base + Slugging) Trends</h2>
              ...
              tooltip: {
                ...
                callbacks: {
                  label: function (tooltipItem) {
                    return `OPS: ${tooltipItem.raw.toFixed(3)}`;
                  }
                }
              }
            },
